export default function Home() {
  return (
    <div className="max-w-4xl mx-auto">
      <section className="relative flex justify-center items-center h-[50vh] overflow-hidden">
        <div className="relative p-8 rounded-2xl border border-gray-700 bg-gray-800/50 backdrop-blur-lg">
          <h1 className="text-4xl md:text-6xl font-extrabold text-center text-white mb-4 leading-tight">
            I craft <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-600">interfaces,</span><br />
            experiences & <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-600">stories.</span>
          </h1>
          <p className="text-center text-lg md:text-xl text-gray-400">
            Web Developer based in Corvallis. <br />
            With experience from BeaverHacks & OSU.
          </p>
        </div>
      </section>
      ...
      <section className="text-center my-16">
        ...
        <div className="flex justify-center space-x-6">
          ...
          <a href="https://www.linkedin.com/in/brandonkngill/" target="_blank" rel="noopener noreferrer" className="text-xl text-purple-400 hover:text-purple-600 transition-colors">LinkedIn</a>
